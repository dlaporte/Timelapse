...
#
# montage 101*.jpg -mode concatenate -tile 1 cabin1.png
# montage 102*.jpg -mode concatenate -tile 1 cabin2.png
# etc...
#
# and then join those using:
#
# montage cabin*.png -mode concatenate -tile <count> cabin.png
#
...
final_directory = '/Users/dlaporte/Dropbox/Code/Timelapse/test-bycol'
